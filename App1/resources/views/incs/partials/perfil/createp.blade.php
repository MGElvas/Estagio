<section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="custom-breadcrumbs">
                    <a href="/perfils">Home</a> <span class="mx-2 slash">/</span>
                    <span class="text-white"><strong>Criar Perfil</strong></span>
                </div>
            </div>
        </div>
        ...
        @if(isset($perfil)){
            <h1 style="color:white">O seu perfil empresarial já esta definido</h1>
        @else
            <div class="row">
                <div class="col-md-8">
                    ...
                    @csrf
                        ...
                        <input type="submit" href="{{route('store')}}" value="Confirmar" class="btn btn-lg btn-success">
                    </form>
                </div>
            </div>        
        @endif
