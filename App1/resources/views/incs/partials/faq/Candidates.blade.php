        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="block__87154 bg-white rounded">
                    ...
                    <div class="block__91147 d-flex align-items-center">
                        <figure class="mr-4"><img src="{{asset('Jobboard/images/person_1.jpg')}}" alt="Image" class="img-fluid"></figure>
                            <div>
            ...
            <div class="col-lg-6">
                <div class="block__87154 bg-white rounded">
                    ...
                    <div class="block__91147 d-flex align-items-center">
                        <figure class="mr-4"><img src="{{asset('Jobboard/images/person_2.jpg')}}" alt="Image" class="img-fluid"></figure>
                        <div>
                            <h3>Chris Peter</h3>
