<section class="site-section">
    <div class="container">
        ...
        <div class="row align-items-center block__69944">
            <div class="col-md-6">
                <img src="{{asset('Jobboard/images/person_6.jpg')}}" alt="Image" class="img-fluid mb-4 rounded">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6 order-md-2 ml-md-auto">
                <img src="{{asset('Jobboard/images/person_5.jpg')}}" alt="Image" class="img-fluid mb-4 rounded">
            </div>
            <div class="col-md-6">
                <h3>Chintan Patel</h3>
                <p class="text-muted">Creative Director</p>
